...
const SkipPage = ({ route }) => {
  ...
  const basePayment = challengeDetails?.basePayment || 50;
  const processingFee = challengeDetails?.processingFee || 2;
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.subtitle}>Skip The Workout</Text>
        </View>
        ...
        <View style={styles.paymentCard}>
          ...
          <View style={styles.selectedChallenge}>
            <View style={styles.challengeHeader}>
              <Text style={styles.challengeTitle}>Skipping more than 2 workouts per month will increase your penalty fees and may disqualify you from bonus rewards. Use this option wisely.</Text>
            </View>
